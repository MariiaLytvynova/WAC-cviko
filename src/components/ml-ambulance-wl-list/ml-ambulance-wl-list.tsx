...
// import { WaitingListApi, WaitingListEntry, Configuration } from '../../api/ambulance-wl';

// import { DefaultApi } from '../../api/ambulance-wl/apis';
// import { WaitingListAmbulanceIdEntriesGet200ResponseInner } from '../../api/ambulance-wl/models';
@Component({
  tag: 'ml-ambulance-wl-list',
  styleUrl: 'ml-ambulance-wl-list.css',
  shadow: true,
})
